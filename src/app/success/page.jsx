...
export default async function Success({ searchParams }) {
  ...
  // ডাটাবেস অপারেশন এবং ডুপ্লিকেট চেক
  ...
  if (recipe && user) {
    ...
    try {
      ...
      // ট্রানজ্যাকশন অলরেডি হয়ে থাকলে বা ডাটাবেস এরর দিলে সাইলেন্টলি হ্যান্ডেল করা
      ...
      <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-8 shadow-sm text-center">
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="flex items-center justify-between bg-zinc-100 dark:bg-zinc-800 rounded-xl p-4 text-left">
            ...
            <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-green-500/10 text-green-600 capitalize">
              {status}
            </span>
          </div>
        </div>
