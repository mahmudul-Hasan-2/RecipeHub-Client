    ...
    <div className="group relative w-full rounded-3xl border border-zinc-200/60 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 backdrop-blur-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col justify-between h-full">
      <div>
        <div className="relative w-full h-44 rounded-2xl overflow-hidden mb-4 bg-zinc-100 dark:bg-zinc-900">
          ...
          <div
            className={`absolute top-3 left-3 text-[10px] font-black uppercase tracking-wider px-3 py-1 rounded-full shadow-sm z-10 ${statusColors[status] || "bg-zinc-500/10 text-zinc-500"}`}
          >
            {status || "Pending"}
          </div>
        </div>
      ...
      <div className="flex items-center gap-2 mt-5 pt-3 border-t border-zinc-100 dark:border-zinc-900/60">
        ...
        <Link href={`/dashboard/user/recipes/edit/${_id}`}>
          <button className="p-2 rounded-xl bg-zinc-100/80 dark:bg-zinc-900/60 text-zinc-600 dark:text-zinc-400 hover:bg-amber-500 hover:text-white dark:hover:bg-amber-500 dark:hover:text-white transition-all">
            <FiEdit2 size={14} />
          </button>
        </Link>

        <button className="p-2 rounded-xl bg-zinc-100/80 dark:bg-zinc-900/60 text-zinc-600 dark:text-zinc-400 hover:bg-rose-500 hover:text-white dark:hover:bg-rose-500 dark:hover:text-white transition-all">
          <FiTrash2 size={14} />
        </button>
      </div>
    </div>
