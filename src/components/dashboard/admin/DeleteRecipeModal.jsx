  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-md rounded-[2rem] border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-950 p-6 sm:p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200 text-center text-sm font-medium text-zinc-800 dark:text-zinc-200">
        ...
        <div className="w-16 h-16 rounded-2xl bg-rose-500/10 flex items-center justify-center text-rose-500 mx-auto mb-5 border border-rose-500/20">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-3 leading-relaxed text-xs sm:text-sm">
          ...
          <span className="font-bold">"{recipe.recipeName}"</span>? This action
          cannot be undone and the dataset will be permanently removed.
        </p>
        ...
        <div className="flex items-center gap-3 mt-8">
          ...
          <button
            ...
            disabled={isDeleting}
            className="flex-1 px-5 py-3 rounded-xl bg-rose-500 hover:bg-rose-600 text-white text-xs font-black uppercase tracking-wider flex items-center justify-center gap-2 shadow-md shadow-rose-500/10 transition-all active:scale-95"
          >
            {isDeleting ? (
              <>
